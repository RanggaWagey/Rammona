            ...
            <div class="card-body">
                ...
                <form action="{{ route('categories.update', $category->id) }}" method="POST">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="@error('name') is-invalid @enderror form-control" name="name" id="name" placeholder="Enter Category Name" value="{{ old('name', $category->name) }}">
                            <!-- Hidden Slug -->
                            <input type="text" class="@error('slug') is-invalid @enderror form-control" name="slug" id="slug" placeholder="Enter Slug" value="{{ old('slug', $category->slug) }}" readonly>
                            @error('name')
