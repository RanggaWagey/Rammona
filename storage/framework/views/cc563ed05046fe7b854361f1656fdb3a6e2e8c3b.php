...
unset($__errorArgs, $__bag); ?> form-control" name="name" id="name" placeholder="Enter Category Name" value="<?php echo e(old('name', $category->name)); ?>">
                            <!-- Hidden Slug -->
...
unset($__errorArgs, $__bag); ?> form-control" name="slug" id="slug" placeholder="Enter Slug" value="<?php echo e(old('slug', $category->slug)); ?>" readonly>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DATA\Applications\dashboard-rammona\resources\views/dashboard/categories/edit.blade.php ENDPATH**/ ?>