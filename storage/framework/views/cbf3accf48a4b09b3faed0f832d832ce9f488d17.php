...
<html lang="zxx">
    <head>
        ...
        <!-- App favicon -->
    <link rel="shortcut icon" href="<?php echo e(URL::asset('frontend/img/logo1.png')); ?>">
        <!-- Google Font -->
        <link
    ...
    <div class="humberger__menu__wrapper">
      <div class="humberger__menu__logo">
        <a href="#"><img src="<?php echo e(asset('frontend/img/Rammona-Bakery.png')); ?>" alt="" /></a>
      </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="footer__widget">
                            <h6>Follow Us :</h6>
                            <div class="mb-4">
                        <img src="<?php echo e(asset('frontend/img/Rammona-Bakery.png')); ?>" alt="" height="70">
                    </div>
