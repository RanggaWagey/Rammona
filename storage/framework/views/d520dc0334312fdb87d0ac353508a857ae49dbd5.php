    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                <form action="<?php echo e(route('categories.updatesub', $subcategory->id)); ?>" method="POST">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DATA\Applications\dashboard-rammona\resources\views/dashboard/categories/sub-categories-edit.blade.php ENDPATH**/ ?>