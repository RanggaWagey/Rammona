                    ...
                    <div class="col-lg-3">
                        <div class="product__discount__item">
                            <div class="product__discount__item__pic set-bg"
                                data-setbg="<?php echo e(asset('storage/' . $product->image)); ?>">
        ...
        <div class="row featured__filter">
            <div class="col-lg-3 col-md-4 col-sm-6 mix Mineral_Water">
                <div class="featured__item">
                    <div class="featured__item__pic set-bg" data-setbg="<?php echo e(asset('frontend/img/drink/mineral.jpeg')); ?>">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix Cold_Drink">
                <div class="featured__item">
                    <div class="featured__item__pic set-bg" data-setbg="<?php echo e(asset('frontend/img/drink/yakin.jpg')); ?>">
                        <ul class="featured__item__pic__hover">
                            <li>
                                <a href="#"><i class="fa fa-heart"></i></a>
                            </li>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix Mineral_Water">
                <div class="featured__item">
                    <div class="featured__item__pic set-bg" data-setbg="<?php echo e(asset('frontend/img/drink/aqua.jpg')); ?>">
                        <ul class="featured__item__pic__hover">
                            <li>
                                <a href="#"><i class="fa fa-heart"></i></a>
                            </li>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix Hot_Drink">
                <div class="featured__item">
                    <div class="featured__item__pic set-bg" data-setbg="<?php echo e(asset('frontend/img/drink/drink.jpg')); ?>">
                        <ul class="featured__item__pic__hover">
                            <li>
                                <a href="#"><i class="fa fa-heart"></i></a>
                            </li>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix Hot_Drink">
                <div class="featured__item">
                    <div class="featured__item__pic set-bg" data-setbg="<?php echo e(asset('frontend/img/drink/kopi.jpg')); ?>">
                        <ul class="featured__item__pic__hover">
                            <li>
                                <a href="#"><i class="fa fa-heart"></i></a>
                            </li>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix Cold_Drink">
                <div class="featured__item">
                    <div class="featured__item__pic set-bg" data-setbg="<?php echo e(asset('frontend/img/drink/dalgona.jpg')); ?>">
                        <ul class="featured__item__pic__hover">
                            <li>
                                <a href="#"><i class="fa fa-heart"></i></a>
                            </li>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix Cold_Drink">
                <div class="featured__item">
                    <div class="featured__item__pic set-bg" data-setbg="<?php echo e(asset('frontend/img/drink/tea.jpg')); ?>">
                        <ul class="featured__item__pic__hover">
                            <li>
                                <a href="#"><i class="fa fa-heart"></i></a>
                            </li>
...
<?php echo $__env->make('layouts.main_one', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\dashboard-rammona\resources\views/product/food.blade.php ENDPATH**/ ?>