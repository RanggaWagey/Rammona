...
<div class="col-lg-8">
    <form action="<?php echo e(route('products.store')); ?>" method="post" class="mb-5" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <select class="form-select" name="sub_category_id">
                <?php $__currentLoopData = $subcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if( old('category_id') == $subcategory->id): ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Administrator\Documents\applications\dashboard_rammona\resources\views/dashboard/products/create.blade.php ENDPATH**/ ?>